...
class SongServiceTest {
  ...
  void getDetailSong() {
    try {
      com.daw.pms.DTO.Result pmsDetailSong = songService.getDetailSong("0", 0);
    ...
    try {
      com.daw.pms.DTO.Result qqmusicDetailSong = songService.getDetailSong("0043hnU117oa5s", 1);
    ...
    try {
      com.daw.pms.DTO.Result ncmDetailSong = songService.getDetailSong("185920", 2);
    ...
    try {
      com.daw.pms.DTO.Result bilibiliDetailSong = songService.getDetailSong("1", 3);
  ...
  void getSongsLink() {
    try {
      com.daw.pms.DTO.Result pmsSongsLink = songService.getSongsLink("0,1", "standard", 0);
    ...
    try {
      com.daw.pms.DTO.Result qqmusicSongsLink =
    ...
    try {
      com.daw.pms.DTO.Result ncmSongsLink =
    ...
    try {
      com.daw.pms.DTO.Result bilibiliSongsLink = songService.getSongsLink("0,1", "standard", 3);
